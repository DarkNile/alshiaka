...
//                                                               children: [
//                                                                 CustomText(
//                                                                   text: selectedCustomizations[cubit
//                                                                               .cartList[index]
//                                                                               .mainProductId
//                                                                               .toString()]
//                                                                           .keys
...
//               BlocBuilder<CheckoutCubit, CheckoutState>(
//                   buildWhen: (_, state) =>
//                       state is AddressesState || state is CheckoutChangeState,
//                   builder: (context, state) {
...
//                                             });
//                                             print(
//                                                 cubit.paymentGetaway[index].id);
//                                             print(cubit
//                                                 .paymentGetaway[index].title);
//                                             print(
//                                                 "***********************************************");
//                                             if (cubit.selectedPaymentGetaways !=
//                                                 cubit.paymentGetaway[index]) {
...
//                               scrollDirection: Axis.horizontal,
//                               children: List.generate(
//                                   cubit.shippingMethods.length, (index) {
//                                 if (cubit.total >
//                                         int.parse(cubit.freeShippingMethods[
//                                             'min_amount']) &&
//                                     cubit.shippingMethods[index].methodId ==
//                                         "flat_rate") {
...
//                                         print(cubit.shippingMethods[index].id);
//                                         print(
//                                             cubit.shippingMethods[index].title);
//                                         print(
//                                             "*************************************************");
//                                         cubit.selectedShippingMethods =
//                                             cubit.shippingMethods[index];
...
//                                 const Spacer(),
//                                 CustomText(
//                                     text: cubit.selectedShippingMethods != null
//                                         ? cubit.selectedShippingMethods!
//                                                     .methodId ==
//                                                 "flat_rate"
...
//                               CustomWebview(
//                                 url:
//                                     'https://alshiaka.com/wp-json/payment/urls/get?order_id=${response['id']}&integrate_type=aps_cc&consumer_key=ck_0aa636e54b329a08b5328b7d32ffe86f3efd8cbe&consumer_secret=cs_7e2c98933686d9859a318365364d0c7c085e557b&lang=en',
//                                 type: "",
//                               ));
...
//       profileId: "64604",
//       serverKey: "SLJNMJHBMJ-JBJNBGTKNM-DHMH69JGJB",
//       clientKey: "CBKMT9-VTNBH9-VKDKNK-RPHBMK",
//       cartId: "cart id",
//       cartDescription: "cart desc",
//       merchantName: "DUNIA AL ASWAF TRADING COMPANY LIMITED",
...
//       merchantApplePayIndentifier: "merchant.com.Digital-Partner.ahshiaka",
...
//     theme.logoImage = "assets/images/icon.png";
